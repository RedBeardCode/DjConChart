...
from ControlChart.models import CalculationRule
from ControlChart.models import CharacteristicValueDefinition
from ControlChart.tests.utilies import create_correct_sample_data
from ControlChart.tests.utilies import login_as_admin
